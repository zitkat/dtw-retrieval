...
from embedding_lib import compute_embeddings, get_pool, get_activation_loader
...
def main(input_file: Path,
    ...
    embed = get_activation_loader(input_folder=input_file.parent, **settings["embedding"])
